        ...
        try {
            ...
            foreach (Cart::content() as $item) {
                ...
                if ($product->stock < $item->qty) {
                    ...
                    DB::rollBack();
                    return redirect()->route('cart.index')->with('error', 'The product "' . $product->name . '"
...
for your purchase.');
            ...
            DB::rollBack();
            return redirect()->route('checkout.index')->with('error', 'An error occurred while placing your
order. Please try again. Error: ' . $e->getMessage());
        }
    }
}
