...
<body
    ...
    <header
        class="w-full max-w-full lg:max-w-4xl mx-auto px-4 py-4 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <nav class="flex items-center gap-3">
            @auth
                @if (Auth::user()->is_admin)
                    <a href="{{ route('admin.dashboard') }}"
                        class="inline-block px-5 py-2 text-sm font-medium text-white bg-indigo-600 rounded hover:bg-indigo-700 transition">
                        Admin Dashboard
                    </a>
                @else
            ...
            @else
                <a href="{{ route('login') }}"
                    class="inline-block px-5 py-2 text-sm font-medium text-indigo-600 border border-indigo-600 rounded hover:bg-indigo-50 transition">
                    Log in
                </a>
